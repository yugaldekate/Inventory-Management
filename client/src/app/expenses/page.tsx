...
import { ExpenseByCategorySummary, useGetExpensesByCategoryQuery } from "@/redux/features/api";
...
const Expenses = () => {
    ...
    const classNames = {
        ...
        selectInput: "mt-1 block w-full pl-3 pr-10 py-2 text-base bg-white border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md",
    };
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="start-date"
                                name="start-date"
                                className={`${classNames.selectInput} custom-date-picker`}
